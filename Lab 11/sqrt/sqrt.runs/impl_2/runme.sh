...
HD_PWD='E:/ENEE245 Verilog code/Lab 11/sqrt/sqrt.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log board_sqrt.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source board_sqrt.tcl -notrace
