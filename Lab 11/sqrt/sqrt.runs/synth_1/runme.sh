...
HD_PWD='E:/ENEE245 Verilog code/Lab 11/sqrt/sqrt.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log board_sqrt.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source board_sqrt.tcl
