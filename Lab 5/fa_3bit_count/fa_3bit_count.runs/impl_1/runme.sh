...
HD_PWD='E:/ENEE245 Verilog code/Lab 5/fa_3bit_count/fa_3bit_count.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log board_fa_3bit_count.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source board_fa_3bit_count.tcl -notrace
