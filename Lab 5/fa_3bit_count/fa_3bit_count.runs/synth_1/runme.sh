...
HD_PWD='E:/ENEE245 Verilog code/Lab 5/fa_3bit_count/fa_3bit_count.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log board_fa_3bit_count.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source board_fa_3bit_count.tcl
