...
HD_PWD='E:/ENEE245 Verilog code/Lab 5/ha_2bit_count/ha_2bit_count.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log board_ha_2bit_count.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source board_ha_2bit_count.tcl -notrace
