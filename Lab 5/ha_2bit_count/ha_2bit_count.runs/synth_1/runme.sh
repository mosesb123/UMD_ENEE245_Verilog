...
HD_PWD='E:/ENEE245 Verilog code/Lab 5/ha_2bit_count/ha_2bit_count.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log board_ha_2bit_count.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source board_ha_2bit_count.tcl
