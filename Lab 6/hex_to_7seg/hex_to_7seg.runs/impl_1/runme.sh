...
HD_PWD='E:/ENEE245 Verilog code/Lab 6/hex_to_7seg/hex_to_7seg.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log board_hex_to_7seg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source board_hex_to_7seg.tcl -notrace
