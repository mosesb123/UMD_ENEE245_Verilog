...
HD_PWD='E:/ENEE245 Verilog code/Lab 6/hex_to_7seg/hex_to_7seg.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log board_hex_to_7seg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source board_hex_to_7seg.tcl
