...
HD_PWD='E:/ENEE245 Verilog code/Lab 8/mulitiplier/mulitiplier.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log multipliers_delays.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source multipliers_delays.tcl -notrace
