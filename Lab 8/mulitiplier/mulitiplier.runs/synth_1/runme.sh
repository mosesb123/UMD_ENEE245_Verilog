...
HD_PWD='E:/ENEE245 Verilog code/Lab 8/mulitiplier/mulitiplier.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multipliers_delays.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multipliers_delays.tcl
